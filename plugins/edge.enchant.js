 ...
 * <p>Requires:<ul>
 * <li>enchant.js v0.5.1 or later.</li>
 * <li>tl.enchant.js v0.5.0 or later.</li>
...
if (enchant != undefined) {
    ...
    (function() {
        ...
        enchant.edge.EdgeGroup = enchant.Class.create(enchant.Group, {
             ...
             * @param [enchant.Entity] entity The reference entity used to nest the other child sprites.
             * @class A class which extendes {@link enchant.Group} by the feature of hosting child entities
             * within the div element of a given entity (if no entity is given a new entity will be created).
             * As the nested children will be translated according to their parent the position calculation
             * of the children will be relative to the parent and the parent field of the Entity will be set to null.
            ...
            /**
             * Method which will remove a node from the group. The reference entity can not be removed.
             * @param {enchant.Entity} entity The child which should be removed.
            ...
            /**
             * Method which will add an entity to the group.
             * The entity's parentNode field will be set to null.
             * The edgeGroup reference will be stored in a edgeGroup field within the entity.
             * @param {enchant.Entity} entity The child to be added to the group.
            ...
            /**
             * Field used to store the parent edgeGroup of this group.
            ...
            /**
             * The scale factor for this edge group.
             * @type {Number}
             */
            scale: {
                get: function() {
            ...
            /**
             * Scales the group by a given factor.
             * @param {Number} scale The scale used to scale the group.
             */
            scaleBy: function(scale) {
                this.scale = this.scale * scale;
            },
            /**
             * The width of the group (= the reference entity's width).
             * @type {Number}
             */
            width: {
                get: function() {
            ...
            /**
             * The height of the group (= the reference entity's height).
             * @type {Number}
             */
            height: {
                get: function() {
        ...
        enchant.edge.EdgeEntity = enchant.Class.create(enchant.Entity, {
             ...
             * @class A class which extends {@link enchant.Entity} to provide additional
             * features like skew and uses a different rendering method to display its content.
            ...
            /**
             * Will translate the edge entity by the given distance (add the new translation to the previous).
             * Translation uses a different value than the entity's x/y value.
             * @param {Number} translateX The amount for the translation in x direction.
             * @param {Number} translateY The amount for the translation in y direction.
             */
            ...
            /**
             * Translation in x direction. Translation uses a different value than the entity's x value.
             * @type {Number}
             */
            translateX: {
                get: function() {
            ...
            /**
             * Translation in y direction. Translation uses a different value than the entity's y value.
             * @type {Number}
             */
            translateY: {
                get: function() {
            ...
            /**
             * Will set both skew values to the new value.
             * @param {Number} skewX The amount for the skew (on the x-axis).
             * @param {Number} skeyY The amount for the skew (on the y-axis).
             */
            ...
            /**
             * The skew x field used for the skew operation on the x-axis.
             * @type {Number}
             */
            skewX: {
                get: function() {
            ...
            /**
             * The skew y field used for the skew y calculation.
             * @type {Number}
             */
            skewY: {
                get: function() {
        ...
        enchant.edge.Sprite = enchant.Class.create(enchant.edge.EdgeEntity, {
             ...
             * by using methods defined in {@link enchant.Sprite}.
